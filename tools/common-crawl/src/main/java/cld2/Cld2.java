...
public class Cld2 {
    ...
    public static Boolean isPolish(String text){
        return detect(text).language.equals("POLISH")?true:false;
    }

//    public static void main(String [ ] args)
//    {
////        String sampleText = "This method must appear within a class, but it can be any class. So here is the above main method enclosed in a class called Temporary. This would normally be in a file named Temporary.java. Your class should implement the Directions interface so that words like North are understood";
//
//        Scanner keyboard = new Scanner(System.in);
//        System.out.println("enter a phrase to language detector");
//        String sampleText = keyboard.nextLine();
////        Result a = detect(sampleText);
//        System.out.print(isPolish(sampleText));
//    }
